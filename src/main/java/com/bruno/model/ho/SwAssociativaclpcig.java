...
/**
 * SwAssociativaclpcig generated by hbm2java
 */
public class SwAssociativaclpcig implements java.io.Serializable {

	private long sequSwAssociativaclpcig;
	...
	private Date dataDiAssociazione;

	public SwAssociativaclpcig() {
	}

	public SwAssociativaclpcig(long sequSwAssociativaclpcig) {
		this.sequSwAssociativaclpcig = sequSwAssociativaclpcig;
	}
	...
	public SwAssociativaclpcig(long sequSwAssociativaclpcig,
			...
			String codiKcigCcigCodCig, Date dataDiAssociazione) {
		this.sequSwAssociativaclpcig = sequSwAssociativaclpcig;
		...
		this.dataDiAssociazione = dataDiAssociazione;
	}

	public long getSequSwAssociativaclpcig() {
		return this.sequSwAssociativaclpcig;
	}

	public void setSequSwAssociativaclpcig(long sequSwAssociativaclpcig) {
		this.sequSwAssociativaclpcig = sequSwAssociativaclpcig;
	}
	...
	public Date getDataDiAssociazione() {
		return this.dataDiAssociazione;
	}

	public void setDataDiAssociazione(Date dataDiAssociazione) {
		this.dataDiAssociazione = dataDiAssociazione;
	}
