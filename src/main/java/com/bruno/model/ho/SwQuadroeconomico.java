...
/**
 * SwQuadroeconomico generated by hbm2java
 */
public class SwQuadroeconomico implements java.io.Serializable {

	private long sequSwQuadroeconomico;
	...
	private String flgTipSpesa;
	private Byte codiKvspVspiCodVoceSpesa;
	private String descKvspVspiDescVoceSpesa;
	private BigDecimal impoFqueImpSpesaEffPrev;

	public SwQuadroeconomico() {
	}

	public SwQuadroeconomico(long sequSwQuadroeconomico) {
		this.sequSwQuadroeconomico = sequSwQuadroeconomico;
	}
	...
	public SwQuadroeconomico(long sequSwQuadroeconomico,
			...
			String flgTipSpesa, Byte codiKvspVspiCodVoceSpesa,
			String descKvspVspiDescVoceSpesa, BigDecimal impoFqueImpSpesaEffPrev) {
		this.sequSwQuadroeconomico = sequSwQuadroeconomico;
		...
		this.flgTipSpesa = flgTipSpesa;
		this.codiKvspVspiCodVoceSpesa = codiKvspVspiCodVoceSpesa;
		this.descKvspVspiDescVoceSpesa = descKvspVspiDescVoceSpesa;
		this.impoFqueImpSpesaEffPrev = impoFqueImpSpesaEffPrev;
	}

	public long getSequSwQuadroeconomico() {
		return this.sequSwQuadroeconomico;
	}

	public void setSequSwQuadroeconomico(long sequSwQuadroeconomico) {
		this.sequSwQuadroeconomico = sequSwQuadroeconomico;
	}
	...
	public String getFlgTipSpesa() {
		return this.flgTipSpesa;
	}

	public void setFlgTipSpesa(String flgTipSpesa) {
		this.flgTipSpesa = flgTipSpesa;
	}

	public Byte getCodiKvspVspiCodVoceSpesa() {
		return this.codiKvspVspiCodVoceSpesa;
	}

	public void setCodiKvspVspiCodVoceSpesa(Byte codiKvspVspiCodVoceSpesa) {
		this.codiKvspVspiCodVoceSpesa = codiKvspVspiCodVoceSpesa;
	}

	public String getDescKvspVspiDescVoceSpesa() {
		return this.descKvspVspiDescVoceSpesa;
	}

	public void setDescKvspVspiDescVoceSpesa(String descKvspVspiDescVoceSpesa) {
		this.descKvspVspiDescVoceSpesa = descKvspVspiDescVoceSpesa;
	}

	public BigDecimal getImpoFqueImpSpesaEffPrev() {
		return this.impoFqueImpSpesaEffPrev;
	}

	public void setImpoFqueImpSpesaEffPrev(BigDecimal impoFqueImpSpesaEffPrev) {
		this.impoFqueImpSpesaEffPrev = impoFqueImpSpesaEffPrev;
	}
