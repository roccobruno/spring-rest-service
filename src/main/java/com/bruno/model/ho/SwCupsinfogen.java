...
/**
 * SwCupsinfogen generated by hbm2java
 */
public class SwCupsinfogen implements java.io.Serializable {
	...
	private String flagKurpUrpiGenEntrate;
	private String flagKurpUrpiLegObiettivo;
	private Long numeKurpInisIntesa;
	private String descKurpInisIntesa;
	private String textKurpSpatCodStruAtt;
	private String descKurpSpatDescStruAtt;
	...
	public SwCupsinfogen() {
	}

	public SwCupsinfogen(long sequSwCups) {
		this.sequSwCups = sequSwCups;
	}

	public SwCupsinfogen(long sequSwCups, String codiKurpUrpiCodLocProg,
			String descKurpUrpiTitoloProg, String textKurpUrpiNoteProg,
			String flagKurpUrpiGenEntrate, String flagKurpUrpiLegObiettivo,
			Long numeKurpInisIntesa, String descKurpInisIntesa,
			String textKurpSpatCodStruAtt, String descKurpSpatDescStruAtt,
		...
		this.flagKurpUrpiGenEntrate = flagKurpUrpiGenEntrate;
		this.flagKurpUrpiLegObiettivo = flagKurpUrpiLegObiettivo;
		this.numeKurpInisIntesa = numeKurpInisIntesa;
		this.descKurpInisIntesa = descKurpInisIntesa;
		this.textKurpSpatCodStruAtt = textKurpSpatCodStruAtt;
		this.descKurpSpatDescStruAtt = descKurpSpatDescStruAtt;
	...
	public String getFlagKurpUrpiGenEntrate() {
		return this.flagKurpUrpiGenEntrate;
	}

	public void setFlagKurpUrpiGenEntrate(String flagKurpUrpiGenEntrate) {
		this.flagKurpUrpiGenEntrate = flagKurpUrpiGenEntrate;
	}

	public String getFlagKurpUrpiLegObiettivo() {
		return this.flagKurpUrpiLegObiettivo;
	}

	public void setFlagKurpUrpiLegObiettivo(String flagKurpUrpiLegObiettivo) {
		this.flagKurpUrpiLegObiettivo = flagKurpUrpiLegObiettivo;
	}

	public Long getNumeKurpInisIntesa() {
		return this.numeKurpInisIntesa;
	}

	public void setNumeKurpInisIntesa(Long numeKurpInisIntesa) {
		this.numeKurpInisIntesa = numeKurpInisIntesa;
	}

	public String getDescKurpInisIntesa() {
		return this.descKurpInisIntesa;
	}

	public void setDescKurpInisIntesa(String descKurpInisIntesa) {
		this.descKurpInisIntesa = descKurpInisIntesa;
	}

	public String getTextKurpSpatCodStruAtt() {
		return this.textKurpSpatCodStruAtt;
	}

	public void setTextKurpSpatCodStruAtt(String textKurpSpatCodStruAtt) {
		this.textKurpSpatCodStruAtt = textKurpSpatCodStruAtt;
	}

	public String getDescKurpSpatDescStruAtt() {
		return this.descKurpSpatDescStruAtt;
	}

	public void setDescKurpSpatDescStruAtt(String descKurpSpatDescStruAtt) {
		this.descKurpSpatDescStruAtt = descKurpSpatDescStruAtt;
	}
